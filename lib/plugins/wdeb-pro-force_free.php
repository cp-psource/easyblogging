...
class Wdeb_Pro_ForceOnFreeSites {
	...
	function add_settings () {
		...
		add_settings_field('wdeb_pro_force_on_free', __('Erzwinge einfachen Modus auf kostenlosen Webseiten', 'wdeb'), array($this, 'render_settings'), 'wdeb_options_page', 'wdeb_settings');
	}
